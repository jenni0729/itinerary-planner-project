...
Itinerary.create(origin: 'San Francisco', destination: 'Baltimore', name: 'Bmore Trip', user_id: 1, departure_date: 04/01/2015, return_date: 04/07/2015)
Itinerary.create(origin: 'Baltimore', destination: 'San Francisco', name: 'SF Trip', user_id: 2, departure_date: 05/01/2015, return_date: 05/07/2015)
Itinerary.create(origin: 'San Francisco', destination: 'London', name: 'London Trip', user_id: 3, departure_date: 06/01/2015, return_date: 06/07/2015)

Activity.create(location: 'Alcatraz', name: 'Alcatraz Trip', itinerary_id: 1, date: 4/02/2015, start_date: 04/01/2015, end_date: 04/07/2015)
Activity.create(location: 'Ghirardelli Square', name: 'Ghirardelli Trip', itinerary_id: 1, date: 4/03/2015, start_date: 04/01/2015, end_date: 04/07/2015)
Activity.create(location: 'National Aquarium', name: 'See Fishies', itinerary_id: 2, date: 5/02/2015, start_date: 05/01/2015, end_date: 05/07/2015)
Activity.create(location: 'Federal Hill', name: 'Fed Hill Trip', itinerary_id: 2, date: 5/03/2015, start_date: 05/01/2015, end_date: 05/07/2015)
Activity.create(location: 'Globe Theater', name: 'Globe Theater Trip', itinerary_id: 3, date: 6/02/2015, start_date: 06/01/2015, end_date: 06/07/2015)
Activity.create(location: 'Buckingham Palace', name: 'Buckingham Trip', itinerary_id: 3, date: 6/03/2015, start_date: 06/01/2015, end_date: 06/07/2015)
